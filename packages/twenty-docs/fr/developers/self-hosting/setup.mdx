...
<Warning>
**Première installation ?** Suivez le [Guide d'installation de Docker Compose](https://docs.twenty.com/fr/developers/self-hosting/docker-compose) pour faire fonctionner Twenty, puis revenez ici pour la configuration.
</Warning>
