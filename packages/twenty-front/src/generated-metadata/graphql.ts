...
export type CreateFieldInput = {
  ...
  isTimelineRollupEnabled?: InputMaybe<Scalars['Boolean']['input']>;
...
export type Field = {
  ...
  isTimelineRollupEnabled?: Maybe<Scalars['Boolean']['output']>;
